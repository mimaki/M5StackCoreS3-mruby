...
static uint8_t raw_scan_rsp_data[] = {
    /* Complete Local Name */
    0x0F, ESP_BLE_AD_TYPE_NAME_CMPL, 'E', 'S', 'P', '_', 'G', 'A', 'T', 'T', 'S', '_', 'M', '5', 'S', '3'   // Length 15, Data Type ESP_BLE_AD_TYPE_NAME_CMPL, Data (ESP_GATTS_DEMO)
};
#else
...
static esp_ble_adv_data_t adv_data = {
    ...
    .min_interval = 0x20, //0x0006, //slave connection min interval, Time = min_interval * 1.25 msec
    .max_interval = 0x40, //0x0010, //slave connection max interval, Time = max_interval * 1.25 msec
    .appearance = 0x00,
